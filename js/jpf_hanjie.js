...
function init() {
   ...
   //Add event handlers for the puzzles buttons
   ...
   // Add an event listener for the mouseupevent
...
function setupPuzzle() {
   /* Match all od the data cells in the puzzle */
   ...
   for (var i = 0; i < puzzleCells.length; i++) {
      ...
      puzzleCells[i].style.cursor = "url(./photos/jpf_pencil.png), pointer";
   }
...
function setBackground(e) {
   ...
   if (e.shiftKey) {
      ...
      cursorType = "url(./photos/jpf_eraser.png), cell";
   }  else if (e.altKey) {
      cellBackground = "rgb(255, 255, 255)";
      cursorType = "url(./photos/jpf_cross.png), crosshair";
   }  else{
      cellBackground = "rgb(101, 101, 101)";
      cursorType = "url(./photos/jpf_pencil.png), pointer";
   }
